...
import { Grid, GridItem, Box, Button, Flex, Card, VStack, HStack, useToast } from '@chakra-ui/react';
import '../../style.css'

function SeatPicker({ event_id, user_id, callback_function, updateIsSoldOut }) {
